...
export default function CreateNodeGuidePage() {
  ...
  useEffect(() => {
    if (
      ...
      (!formData.title || formData.title.startsWith("How to setup"))
    ) {
          ...
          <div className="space-y-8">
            ...
            <Card className="border-slate-200 bg-white/50 dark:border-slate-800/50 dark:bg-slate-950/10 shadow-sm">
              ...
              <CardContent className="space-y-6">
                <div>
                  <Label
                    htmlFor="title"
                    className="mb-2 block text-slate-700 dark:text-slate-300 font-medium"
                  >
                    Guide Title
                  </Label>
                  <Input
                ...
                {/* Node Image Upload */}
                <div>
                  <Label className="mb-2  text-slate-700 dark:text-slate-300 font-medium flex items-center gap-2">
                  ...
                  />
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    Optional: Upload an image showing what this node looks like
                    in n8n workflow
                  </p>
                </div>
            ...
            <Card className="border-orange-200 bg-orange-50/50 dark:border-orange-800/50 dark:bg-orange-950/20 shadow-sm">
              ...
              <CardContent className="space-y-6">
                <div>
                  <Label
                    htmlFor="credentialGuide"
                    className="mb-2 block text-orange-800 dark:text-orange-200 font-medium"
                  >
                  ...
                  <p className="text-sm text-orange-600 dark:text-orange-400 mt-1">
                    Write clear, step-by-step instructions for getting and
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {credentialsLinks.map((link, index) => (
                      <div
                        key={index}
                        className="flex gap-4 p-3 bg-white/60 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800/50 rounded-lg"
                      >
            ...
            <Card className="border-emerald-200 bg-white/50 dark:border-emerald-800/50 dark:bg-emerald-950/10 shadow-sm">
              ...
              <CardContent>
                <div>
                  <Label
                    htmlFor="setupInstructions"
                    className="mb-2 block text-emerald-800 dark:text-emerald-200 font-medium"
                  >
                  ...
                  <p className="text-sm text-emerald-600 dark:text-emerald-400 mt-1">
                    Instructions for using the service after credentials are set
                    up
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  {helpLinks.map((link, index) => (
                    <div
                      key={index}
                      className="flex gap-4 p-3 bg-white/60 dark:bg-slate-950/20 border border-slate-200 dark:border-slate-800/50 rounded-lg"
                    >
                      <div className="flex-1">
                        <Input
              ...
              <CardContent>
                <div className="space-y-6">
                  {troubleshootingItems.map((item, index) => (
                    <div
                      key={index}
                      className="border border-amber-200 dark:border-amber-800/50 rounded-lg p-4 bg-white/60 dark:bg-amber-950/20"
                    >
                      <div className="space-y-3">
                        ...
                        <div>
                          <Label className="text-amber-800 dark:text-amber-200 font-medium mb-2 block">
                            Solution
                          </Label>
                          <Textarea
