...
import { fetchProfile, getUserCompletePortfolioAction } from "@/utils/actions";
...
export default function UserPortfolioPage() {
  ...
  const loadData = async () => {
    try {
      ...
      // 🚀 NEW: Use the ULTIMATE efficiency function to get everything in ONE query!
      const portfolioResult = await getUserCompletePortfolioAction(
        profileData.clerkId
      );
              ...
              <Card className="border-2 border-dashed border-muted-foreground/20">
                <CardContent className="py-8 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Check back soon for new automation solutions!
                  </p>
                </CardContent>
              </Card>
            ) : (
