      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            See how students built their portfolios and started earning with n8n
            automation skills
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-card border-2 border-blue-500/20 rounded-2xl p-6 hover:border-blue-500/40 transition-colors">
              ...
              <p className="text-base mb-6 font-medium">
                &quot;Quit my $45k marketing job after landing 3 clients in 2
                months. My Slack-to-Google Sheets lead automation is now my
                $8k/month cash cow.&quot;
              </p>
          ...
          {/* Testimonial 2 - Career Revolution */}
          <div className="relative group">
            ...
            <div className="relative bg-card border-2 border-green-500/20 rounded-2xl p-6 hover:border-green-500/40 transition-colors">
              ...
              <p className="text-base mb-6 font-medium">
                &quot;Built my first n8n automation portfolio and landed a
                $3,200 client project within 6 weeks. The customer support
                automation I learned here was exactly what they needed.&quot;
              </p>
              <div className="flex items-center gap-3">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-card border-2 border-purple-500/20 rounded-2xl p-6 hover:border-purple-500/40 transition-colors">
              ...
              <p className="text-base mb-6 font-medium">
                &quot;Week 3 of the course and I just invoiced $2,400 for
                automating a real estate agent&apos;s lead follow-up system.
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold">Jake Thompson</div>
                  <div className="text-sm text-muted-foreground">
                    College Senior
                  </div>
                </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 rounded-2xl p-8 border">
            ...
            <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
              Join hundreds of students who turned their n8n skills into real
