          ...
          <div className="mt-6">
            <div className="flex items-center gap-3">
              <Button
                ...
                variant="outline"
                size="sm"
                className="flex-1 h-10 bg-white/60 dark:bg-slate-800/60 hover:bg-white/80 dark:hover:bg-slate-700/80 border-white/60 dark:border-slate-600/60"
              >
                {isExpanded ? (
                  <>
                          ...
                          Object.entries(step.parameters || {}).filter(
                            ([key]) =>
                              !promptKeys.some((promptKey) =>
                                key
                                  .toLowerCase()
                                  .includes(promptKey.toLowerCase())
                              )
                          )
                        );
                      } else if (isCodeNode()) {
